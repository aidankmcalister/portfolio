...
Built with [Astro](https://astro.build) and [Tailwind CSS](https://tailwindcss.com), deployed on Vercel. Static, no client JavaScript. Work and writing are driven by a single data file and a Markdown content collection, which also feed `/sitemap.xml`, `/llms.txt`, and `/llms-full.txt`.
